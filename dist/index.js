...
function Accordion(_ref) {
  ...
  }, header, React__default.createElement("strong", {
    style: {
      "float": 'right'
    },
    className: "tooltip",
...
function Avatar(_ref) {
  ...
  }, children, status && React__default.createElement("i", {
...
function Card(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    className: "card-header"
  }, !!actions.length && React__default.createElement("div", {
    className: "btn-group float-right"
...
function Chip(_ref) {
  ...
  return React__default.createElement("span", {
    ...
    size: "small",
    initial: initial
  }, avatar), children, close && React__default.createElement(Button, {
    type: "clear",
    "float": "right",
    onClick: close
  }));
...
function Divider(_ref) {
  var _ref$type = _ref.type,
      ...
      name = _ref.name;
  return name ? React__default.createElement("div", {
...
function Icon(_ref) {
  ...
  return description ? React__default.createElement("i", {
...
function Empty(_ref) {
  ...
  }, subtitle), action && React__default.createElement("div", {
...
function FieldSet(_ref3) {
  ...
  return React__default.createElement("fieldset", null, children);
}
...
function Select(_ref9) {
  ...
  return React__default.createElement("select", _extends({
    ...
    multiple: multiple
  }, props), placeholder && React__default.createElement("option", {
    key: 'option_empty',
    value: ""
...
function Switch(_ref12) {
  ...
  return React__default.createElement("label", {
    ...
    className: "form-icon"
  }), on ? React__default.createElement("strong", null, onLabel) : offLabel);
}
...
function FileInput(_ref15) {
  ...
  var content = acceptedFiles.length > 0 ? React__default.createElement("ul", null, acceptedFiles.map(function (file) {
  ...
  return React__default.createElement("section", {
    ...
    style: style
  }), React__default.createElement("input", getInputProps()), content));
}

var sizes = basic.Range({
  start: 1,
  end: 12
}).toArray();
...
function Layout(_ref) {
  ...
  var nav = navigation.length === 1 ? React__default.createElement("span", {
    className: "navbar-brand"
  }, text) : React__default.createElement("ul", {
  ...
  return React__default.createElement("div", null, React__default.createElement("header", {
    className: "navbar",
  ...
  }, nav), React__default.createElement("section", {
    className: "navbar-section"
  }, React__default.createElement("div", {
...
function List(_ref) {
  ...
  var Container = function Container(_ref2) {
    var children = _ref2.children;
    return horizontal ? React__default.createElement("div", {
      style: {
  ...
  var Elements = function Elements(_ref3) {
    ...
    return items && items.length ? items.map(function (props, i) {
      ...
      }, React__default.createElement(Body, null, React__default.createElement(Item, _extends({
        index: i
      }, props))));
    }) : Empty$1 ? React__default.createElement(Empty$1, null) : React__default.createElement(Empty, {
      icon: icon,
  ...
  var Content = function Content(_ref5) {
    var Body = _ref5.Body;
    return React__default.createElement(ListBody, null, React__default.createElement(Elements, {
      Body: Body
    }));
  };
  ...
  var Div = function Div(_ref6) {
    ...
    return React__default.createElement("div", props, children);
  };

  var _ref7 = single ? [React__default.createElement(Content, {
    Body: Div
  }), null] : [null, React__default.createElement(Content, {
    Body: Card
  })],
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Card, {
    title: React__default.createElement("div", {
      ...
      name: icon,
      description: name
    }), React__default.createElement("span", null, name.toUpperCase(), ":")), React__default.createElement("div", {
      className: "d-inline-block"
    }, info)),
    actions: actions,
